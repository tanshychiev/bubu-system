...
urlpatterns = [
    ...
    # ==================================================
    # MOBILE STOCK COUNT
    # Keep before the general <int:pk> item routes.
    # ==================================================
    path("stock/count/", stock_count_views.stock_count_list, name="stock_count_list"),
    path("stock/count/start/", stock_count_views.stock_count_start, name="stock_count_start"),
    path("stock/count/<int:pk>/", stock_count_views.stock_count_detail, name="stock_count_detail"),
    path(
    ...
    path(
        "stock/count/<int:pk>/line/<int:line_id>/apply/",
        stock_count_views.stock_count_apply_line,
        name="stock_count_apply_line",
    ),
    path(
        "stock/count/<int:pk>/line/<int:line_id>/history/",
        stock_count_views.stock_count_line_history,
        name="stock_count_line_history",
    ),
    path(
