...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0006_alter_itemvariant_options_and_more'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='VariantEditHistory',
            fields=[
                ...
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='edit_histories', to='inventory.itemvariant')),
            ],
            options={
